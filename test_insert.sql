...
('Jamaican Jerk Chicken', 'Grilling and BBQ'),
('Jamaican Jerk Chicken', 'Comfort Food'),
('Jamaican Jerk Chicken', 'Family Favorites'),
('Jamaican Jerk Chicken', 'Quick and Easy'),
('Jamaican Jerk Chicken', 'Healthy Choices'),
('Jamaican Jerk Chicken', 'Summer BBQ'),
('Jamaican Jerk Chicken', 'Picnic Treats'),
('Jamaican Jerk Chicken', 'Slow Cooker Favorites'),
('Jamaican Jerk Chicken', 'Date Night Dinners'),
...
('Buckwheat Tabboulah', 'Grilling and BBQ'),
('Buckwheat Tabboulah', 'Comfort Food'),
('Buckwheat Tabboulah', 'Family Favorites'),
('Buckwheat Tabboulah', 'Quick and Easy'),
('Buckwheat Tabboulah', 'Healthy Choices'),
('Buckwheat Tabboulah', 'Summer BBQ'),
('Buckwheat Tabboulah', 'Game Day Snacks'),
('Buckwheat Tabboulah', 'Christmas'),
('Buckwheat Tabboulah', 'Seafood'),
('Buckwheat Tabboulah', 'Vegetarian'),
('Buckwheat Tabboulah', 'Desserts and Sweeteners'),
('Buckwheat Tabboulah', 'Gluten-Free'),
('Buckwheat Tabboulah', 'Vegan Delights'),
('Buckwheat Tabboulah', 'Soup and Stew'),
('Buckwheat Tabboulah', 'Baking Adventures'),
('Buckwheat Tabboulah', 'Budget-Friendly'),
('Buckwheat Tabboulah', 'Brunch Ideas'),
('Buckwheat Tabboulah', 'Picnic Treats'),
('Buckwheat Tabboulah', 'Slow Cooker Favorites'),
('Buckwheat Tabboulah', 'Date Night Dinners'),
...
UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Jamaican Jerk Chicken';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Pasta Salad';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Lasagna';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Hearty Pancakes';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Summer Garden Couscous Salad';

UPDATE recipes
SET portions = 1
WHERE recipe_name = 'Squash Corn Chowder';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'White beans, tomatoes, and spinach';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Spaghetti';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Scones';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Pizza';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Stir-Fry';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Rustic Italian Tortellini Soup';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Swedish Meatballs';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Barley Beef Skillet';

UPDATE recipes
SET portions = 1
WHERE recipe_name = 'Southwest Beef & Rice Skillet';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Glazed Pork Chops with Corn Bread Dressing';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Fried Rice';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Zesty Sausage & Beans';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Prosciutto Pasta Toss';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Cashew Chicken with Noodles';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Herb Chicken with Honey Butter';
...
UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Swedish Pancakes';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Baked Cheddar Eggs & Potatoes';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Baked Mostaccioli';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Ravioli with Snap Peas';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Cloverleaf Rolls';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Greek Yogurt and Honey Blueberry Muffins';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Whole Grain Waffles';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Lemon Bars';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Qahaq Cookies';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Blondies with Nutella';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Hot Chocolate';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Chocolate Mousse';

UPDATE recipes
SET portions = 1
WHERE recipe_name = 'S\'mores Cookie Bars';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Orange Chicken';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Tostadas';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Black Bean Stuffed Sweet Potatoes';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Asian Shredded Beef';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Capellini with sausage, spinach, and jalapeno';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Crispy Chicken with Kale';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Roast Chicken Grain Bowl';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Chicken thighs with barley and peas';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Rice noodles with meatballs and bok choy';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Paprika Pork with Roasted Potatoes and Dill Cream';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Chicken cutlets with carrot and kale salad';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Gnocchi and sweet potatoes';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Shepherd\'s Pie';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Garlic Parmesan Chicken';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Turkey Pot Pie';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Balsamic Bacon Brussels Sprouts';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Lemon Red Potatoes';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Potato and Corn Chowder';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Thai Chicken';

UPDATE recipes
SET portions = 1
WHERE recipe_name = 'Italian Fagoli Vegetable Soup';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Blueberry Pie';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Chocolate Pudding';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Browned Butter Beets';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Turkey Soup with Homemade Noodles';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Home fries';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Chocolate Raspberry Torte';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Golden Latte';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Fig Shake';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Lentil Soup';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Buckwheat Tabboulah';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Lentil Rice Bowls with Egg';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Italian Vegetable Lentil Soup';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'One Pot Chicken & Potatoes';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Sweet Korean Lentils';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Buckwheat Beetroot Salad';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'New Potato Lentil Salad';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Ham & Potato Soup';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Lemon Dill Potatoes';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'BBQ Lentils';

UPDATE recipes
SET portions = 1
WHERE recipe_name = 'Healthy Buckwheat Soup';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Buckwheat Chicken Pilaf';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Vegetable Noodle Soup';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Bacon and Honey Potato Salad';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Pretzel Sticks';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Golden French Lentil Soup';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Lentil Shepherd\'s Pie';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Honey Lime Chicken';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Lentil Curry';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Dutch Oven Bread';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Potato Apple Roast';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Baking Powder Biscuits';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Sugar Cookies';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Potato Curry';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Bucatini all\'Amatriciana';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Brioche Chocolate Rolls';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Naan';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Lemon Poppy Seed Scones';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Balsamic Dijon Root Vegetables';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Best Baked Chicken Legs';

UPDATE recipes
SET portions = 1
WHERE recipe_name = 'Spanish Lentil Soup';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Chocolate Chip Irish Soda Bread';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Malteese Gilatti';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Buckwheat Carrot and Onion';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Sweet Potatoes with Yogurt and Chickpeas';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Spanish Chickpeas';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Lemon Fettuchini';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Chickpea Masala';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Chickpea Broccoli Pesto';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Thai Veggie Soup';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Buttery Herb Chicken';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Rosemary Parsnips';

UPDATE recipes
SET portions = 5
WHERE recipe_name = 'Balsamic Potatoes and Asparagus';

UPDATE recipes
SET portions = 3
WHERE recipe_name = 'Quinoa Brussels Sweet Potato Salad';

UPDATE recipes
SET portions = 4
WHERE recipe_name = 'Thai Peanut Cabbage Quinoa';

UPDATE recipes
SET portions = 2
WHERE recipe_name = 'Lemon Garlic Asparagus with Orzo';
